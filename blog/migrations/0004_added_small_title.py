...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.small_title'
        db.add_column(u'blog_article', 'small_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.small_title'
        db.delete_column(u'blog_article', 'small_title')
    ...
    models = {
        ...
        u'blog.article': {
            ...
            'small_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
