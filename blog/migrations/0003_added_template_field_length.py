...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.template'
        db.alter_column(u'blog_article', 'template', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Article.template'
        db.alter_column(u'blog_article', 'template', self.gf('django.db.models.fields.CharField')(max_length=1))
